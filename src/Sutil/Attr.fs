...
module Css =
    ...
    let fontStyle      (n:obj) = cssAttr("font-style",n)
    ...
    let bottom           (n:obj) = cssAttr("bottom",n)
    let right           (n:obj) = cssAttr("right",n)
    ...
    let textDecorationThickness (n:obj) = cssAttr("text-decoration-thickness",n)
    let borderSpacing  (n:obj) = cssAttr("border-spacing",n)
    let letterSpacing  (n:obj) = cssAttr("letter-spacing",n)
    ...
    let gridTemplateColumns (n:obj) = cssAttr("grid-template-columns",n)
    let gridGap        (n:obj) = cssAttr("grid-gap",n)

    let stroke          (n:obj) = cssAttr("stroke",n)
    let fill            (n:obj) = cssAttr("fill",n)
    let strokeDasharray (n:obj) = cssAttr("stroke-dasharray",n)
    let textAnchor      (n:obj) = cssAttr("text-anchor",n)
#else
